...
namespace StuMS.Areas.Student.Controllers
{
    ...
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Dob,Email")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Dob,Email")] Student student)
        {
            if (id != student.Id)
            {
                return NotFound();
